...
@IBDesignable public class SignatureView: UIView {
    ...
    ///   - touch: Initial Touch
    ///   - event: touch event
    override public func touchesBegan(_ touch: Set<UITouch>, with event: UIEvent?)
    {
    ...
    ///   - event: touch event
    override public func touchesMoved(_ touch: Set<UITouch>, with event: UIEvent?)
    {
    ...
    ///   - touch: Last Touch
    ///   - event: touch event
    override public func touchesEnded(_ touch: Set<UITouch>, with event: UIEvent?)
    {
        guard ctr == 0 else {
            ctr = 0
            return
    ...
    /// Get captured view
    @objc public var signature: UIImage? {
        guard !isEmpty else {
            return nil
        }
